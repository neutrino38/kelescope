defmodule KelescopeWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    >
      <div class={[
        ...
        <div class="flex-1" />
        <button type="button" class="group self-start cursor-pointer" aria-label={gettext("fermer")}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KelescopeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KelescopeWeb.Gettext, "errors", msg, opts)
    end
  end
